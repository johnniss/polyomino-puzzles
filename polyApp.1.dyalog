    ...
    :class pagesetup                                   
        ...
        ∇ new pageno
          ...
          :Case home
              ...
              before←1 1 1 1 1
          :Case solve
              tabclass←FrontPage #.polyPuzzlMan4d #.polyPuzzlSolve #.polyPuzzlReplay #.testPuzzlReplay4D
        ...
        ∇ guisetup subform
         ...
         ⍝ backward and forward butns
          ...
          :For but ix :InEach (fastbackward backward forward fastforward chapterno carpet)(⍳6) ⍝ setbookmk getbookmk)(⍳8)
              but.FontObj←APL 20 ⋄ but.Size←30 50 ⍝ but.Posn←0(300+(ix×55)+((ix=4)×20)+((ix=5)×80)+(ix>5)×170)
